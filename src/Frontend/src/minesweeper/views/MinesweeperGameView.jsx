...
const IHint = (
        <svg width="26"
             ...
             fill="none"
        >
            <path d="M12 3a7 7 0 017 7c0 2.6-1.5 4.6-3.5 5.8V19a1 1 0 01-1 1h-5a1 1 0 01-1-1v-3.2A6.9 6.9 0 015 10a7 7 0 017-7z"
                  stroke="white"
            />
            <path d="M9 22h6"
                  stroke="white"
...
const IUndo = (
        ...
        >
            <path d="M7 7l-4 4 4 4"
                  stroke="white"
            />
            <path d="M3 11h10a5 5 0 110 10h-2"
                  stroke="white"
            />
        </svg>
);
...
export function MinesweeperGameView() {
    ...
    useEffect(() => {
        ...
        if(view?.board?.lostOn && ((view?.lives?.total > 0 && view?.lives?.left > 0) || (view?.lives?.total === 0 && view?.lives?.left === 0))) {
            if(!explodedMode) {
                        ...
                        {!isGameOver && !isExploded ? (
                                ...
                                <span style={{color: colors.text, fontWeight: 700, minWidth: 56}}>
                                    ...
                                    <div style={{display: "flex", gap: 16, flexWrap: "wrap", justifyContent: "center"}}>
                                        <ActionPill
                                                onClick={doUndoAndRevive}
                                                disabled={busy}
                                        >
                                            Undo & Revive
                                        </ActionPill>
                                        <ActionPill
                                                onClick={doReviveFromMove}
                                                disabled={busy}
                                        >
