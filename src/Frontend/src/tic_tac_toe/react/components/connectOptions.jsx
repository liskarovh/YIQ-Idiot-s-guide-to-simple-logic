/**
 * @file    connectOptions.jsx
 * @brief   Visual examples of connection patterns for X marks.
 *
...
export default function ConnectOptions() {
    ...
    return (
            <div
                    style={{
                        display: 'grid',
                        gridAutoFlow: 'column',   // always laid out in a row
                        alignItems: 'center',
                        columnGap: S.gapOut,
                        minWidth: 0
                    }}
            >
                {/* 1) two X marks side by side */}
                <div style={cell}>
                ...
                {/* 2) two X marks stacked vertically */}
                <div style={cell}>
                ...
                {/* 3) two X marks on the main diagonal */}
                <div style={cell}>
                    <div
                            style={{
                                display: 'grid',
