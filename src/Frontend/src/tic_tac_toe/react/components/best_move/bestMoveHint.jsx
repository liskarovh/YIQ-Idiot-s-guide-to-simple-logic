/**
 * @file    bestMoveHint.jsx
 * @brief   React component that renders a visual hint for the recommended move on board.
 *
...
export default function BestMoveHint({
                                         size,
                                         move,          // best move [row, col]
                                         show,
                                         cellInset = 2, // inset in px from the cell border
                                         mark = 'X',    // 'X' | 'O'
                                     }) {
    ...
    return (
            <div aria-label="best-move-hint" style={boxStyle}>
                {/* background for a soft glow effect */}
                <div style={{
